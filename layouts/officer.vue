<template>
    <div class="drawer lg:drawer-open">
        <input v-model="isDrawerOpen" id="officer-drawer" type="checkbox" class="drawer-toggle" />
        <div class="drawer-content bg-background-gray flex flex-col min-h-svh lg:h-auto">
            <label for="officer-drawer" class="drawer-button btn btn-square lg:hidden m-4 bg-white">
        ...
        <div class="drawer-side border-e border-border-divider bg-transparent lg:bg-primary">
            <label for="officer-drawer" aria-label="close sidebar" class="drawer-overlay"></label>
            ...
            <ul class="menu h-svh lg:h-auto w-80 pt-4 gap-4 px-4 bg-primary">
                ...
                <li v-for="menu in officerMenuItems" :key="menu.label">
                    <MenuItem
                        :menu="menu"
                        @click="toggleDrawer"
                    />
...
<script setup lang="ts">
    ...
    const officerMenuItems: Ref<Array<MenuItemArgs>> = ref([
        {
            label: "Dashboard",
            route: "/officer/home",
